...
export const Contact = () => {
  return <section id="contact" className="py-20 md:py-28 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Get in touch with our team to discuss your construction or security needs. We're here to help you find the right solution.
          </p>
        </div>
          ...
          <div className="lg:w-2/5">
            <div className="bg-white p-8 rounded-2xl shadow-lg h-full">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+260 977 405569</p>
                    <p className="text-gray-600 mt-1">+260 955 500704</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@kasheinvestments.com</p>
                  </div>
                </div>
              ...
              <div className="mt-10 pt-8 border-t border-gray-200">
                <h4 className="font-semibold text-gray-900 mb-4 text-lg">Follow Us</h4>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <form className="space-y-6">
                ...
                <div>
                  <button 
                    type="submit" 
                    className="inline-flex items-center justify-center px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white font-medium rounded-lg transition-colors shadow-lg w-full"
                  >
